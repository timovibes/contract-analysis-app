...
from .views import ContractReprocessView, PendingUsersView, ApproveUserView, RejectUserView, AnalyticsSummaryView
...
urlpatterns = [
    ...
    path("admin/users", AllUsersView.as_view(), name="admin-all-users"),
